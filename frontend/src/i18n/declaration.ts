...
export enum I18nKey {
  ...
  AZURE_DEVOPS$ORGANIZATION_LABEL = "AZURE_DEVOPS$ORGANIZATION_LABEL",
  AZURE_DEVOPS$PROJECT_LABEL = "AZURE_DEVOPS$PROJECT_LABEL",
  AZURE_DEVOPS$TOKEN_HELP_TEXT = "AZURE_DEVOPS$TOKEN_HELP_TEXT",
  AZURE_DEVOPS$TOKEN_HELP_LINK = "AZURE_DEVOPS$TOKEN_HELP_LINK",
}
